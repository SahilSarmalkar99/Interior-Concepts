    ...
    <section ref={sectionRef}>
      <div className="flex md:flex-row flex-col justify-between items-start h-[300px] md:h-full">
        ...
        <div className="flex items-center gap-3">
          ...
          <p className="text-[20px] md:text-lg lg:text-xl tracking-tighter leading-tight">
        ...
        <div className="w-[300px] md:max-w-[360px]">
          <h2 className="text-[24px]  md:text-[32px] leading-tight tracking-tighter">
        ...
        <div className="max-w-[360px]">
          <p className="text-[18px]  md:text-[16px] leading-tight tracking-tighter text-black/80">
            Our approach weaves innovation, intention, and craftsmanship to
